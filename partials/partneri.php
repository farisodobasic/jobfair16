...
<div id="svi_partneri">
      ...
      <!--<div class="c_zlatni">
        ...
        <ul id="lista">
            <div class="partneri_box">
  	           <li >
                <a href="partials/profil-bhtelecom.html">
                  <img id="telekom-zlatni" src="img/kompanije/bht.png" alt="BH Telecom">
                </a>
              </li>
            </div>
        </ul>
      ...
      <div class="c_ucesnici">
  	       ...
  	       <div class="partneri_box">
              ...
              <!--<li>
                <a href="http://www.ping.ba/">
                  <img id="ping-b" src="img/kompanije/ping.png" alt="Ping">
                </a>
              </li>-->
              <!--<li>
                <a href="partials/profil-qss.html">
              ...
              <!--<li>
                <a href="http://www.haproxy.com/">
                  <img id="reflected-b" src="img/kompanije/haproxy.jpg" alt="HAProxy">
                </a>
              </li>-->
              <!--<li>
                <a href="partials/profil-procredit.html">
                  <img id="procredit-b" src="img/kompanije/procredit.png" alt="ProCredit">
                </a>
              </li>-->
              ...
              <!--<li>
                <a href="partials/profil-klika.html">
                  <img id="klika-b" src="img/kompanije/klika.jpg" alt="Klika">
                </a>
              </li>-->
              <!--<li>
                <a href="partials/profil-infostudio.html">
                  <img id="infostudio-b" src="img/kompanije/infostudio.png" alt="Infostudio">
                </a>
              </li>-->
              <!--<li>
                <a href="http://www.deling.biz/">
                  <img id="deling-b" src="img/kompanije/deling.png" alt="Deling">
                </a>
              </li>-->
          </div>
        </ul>
        ...
        <div class="c_partneri">
              ...
              <ul id="lista">
                 <li> <div id="pin"class="slika_partneri"><a href="http://www.ping.ba/"><img src="img/komplogo/ping.png" alt="Ping"></a></div></li>
