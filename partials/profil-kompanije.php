<div class="header-profil">
	...
	<div class="profil-podaci" >
        <a href="http://<?$item->web;?>"><img src="http://api.jobfair.ba/static/kompanije/<?=$item->id;?>.png" style="width:250px; margin-left:18%" class="slika-kompanije" alt="API"></a>
        <div>
        ...
        <div class="kompanije-kontakt">
            ...
            <p class="web-kompanije"><a href= "<?=$item->web?>"><?=$item->web?></a></p>
