      ...
      <div class="right-col">
        <div class="section">
          <?php
            ...
            $json = file_get_contents('http://api.jobfair.ba/api/posts');
            $obj = json_decode($json);
            foreach($obj as $item){
              /* HTML rendering */
              ?>
              <div class="novost">
                  <div class="img-holder" style="overflow:hidden;height:160px;">
                    <img style="width:100%;" src="http://api.jobfair.ba/static/news/t_<?=$item->id;?>.jpg" />
                  </div>
                  <div class="info">
                    <h1><?=$item->naslov;?></h1>
                    <span>
